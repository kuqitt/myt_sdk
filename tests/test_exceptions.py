...
class TestMYTSDKExceptions(unittest.TestCase):
    ...
    def test_download_error(self):
        ...
        self.assertEqual(str(error), "[DOWNLOAD_ERROR] 下载失败 (URL: http://example.com)")
    ...
    def test_process_error(self):
        ...
        self.assertEqual(str(error), "[PROCESS_ERROR] 进程启动失败 (Process: test_process)")
    ...
    def test_exception_with_details(self):
        """测试带详细信息的异常"""
        error = MYTSDKDownloadError("下载失败", url="http://example.com", status_code=404)
