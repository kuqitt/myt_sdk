...
class TestMYTAPIClient:
    ...
    def test_login_success(self, requests_mock):
       ...
       expected_response = {
           "code": 200,
           "msg": "5b7b1487fc2f659ae1cb748b5e937b0f"
       }
       
       requests_mock.get(f"{self.base_url}/login/{username}/{password}", json=expected_response)
    ...
    def test_query_myt_devices_success(self, requests_mock):
       ...
       requests_mock.get(f"{self.base_url}/host_api/v1/query_myt", json=expected_response)
    ...
    def test_get_image_list_v2_success(self, requests_mock):
       ...
       requests_mock.get(f"{self.base_url}/host_api/v1/get_img_list", json=expected_response)
    ...
    def test_connection_error(self, requests_mock):
       """测试连接错误"""
       requests_mock.get(f"{self.base_url}/version", exc=requests.exceptions.ConnectionError)
    ...
    def test_create_android_container_basic(self, requests_mock):
       ...
       requests_mock.post(
           ...
           json={"code": 200, "msg": "容器创建成功", "data": {"container_id": "test_123"}}
       )
    ...
    def test_create_a1_android_container_basic(self, requests_mock):
       ...
       requests_mock.post(
           ...
           json={"code": 0, "message": "A1容器创建成功", "data": {"container_id": "a1_test123"}}
       )
    ...
    def test_create_a1_android_container_advanced(self, requests_mock):
       ...
       requests_mock.post(
           ...
           json={"code": 0, "message": "A1容器创建成功", "data": {"container_id": "a1_advanced123"}}
       )
    ...
    def test_create_p1_android_container_basic(self, requests_mock):
       ...
       requests_mock.post(
           ...
           json={"code": 0, "message": "P1容器创建成功", "data": {"container_id": "p1_test123"}}
       )
    ...
    def test_create_p1_android_container_with_proxy(self, requests_mock):
       ...
       requests_mock.post(
           ...
           json={"code": 0, "message": "P1容器创建成功", "data": {"container_id": "p1_proxy123"}}
       )
    ...
    def test_create_container_with_port_mapping(self, requests_mock):
       ...
       requests_mock.post(
           ...
           json={"code": 0, "message": "容器创建成功", "data": {"container_id": "port_mapping123"}}
       )
    ...
    def test_run_android_container(self):
       ...
       with patch.object(self.client, '_make_request') as mock_request:
           ...
           result = self.client.run_android_container("192.168.1.100", "test_container")
    ...
    def test_upload_url_file_to_android(self):
       ...
       with patch.object(self.client, '_make_request') as mock_request:
           ...
           result = self.client.upload_url_file_to_android(
               ...
               "https://example.com/file.apk", "/sdcard/Download/file.apk", 3
           )
           
           assert result['code'] == 200
           mock_request.assert_called_once_with(
               'POST', '/upload2_file/192.168.1.100/test_container',
               data={
    ...
    def test_get_clipboard_content(self):
       ...
       with patch.object(self.client, '_make_request') as mock_request:
           ...
           result = self.client.get_clipboard_content("192.168.1.100", "test_container")
           
           assert result['code'] == 200
           mock_request.assert_called_once_with('GET', '/clipboard_get/192.168.1.100/test_container')
    ...
    def test_set_clipboard_content(self):
       ...
       with patch.object(self.client, '_make_request') as mock_request:
           ...
           assert result['code'] == 200
           mock_request.assert_called_once_with(
               'GET', '/clipboard_set/192.168.1.100/test_container',
    ...
    def test_download_file_from_android(self):
        ...
        with patch.object(self.client, '_make_request') as mock_request:
            ...
            result = self.client.download_file_from_android(
                "192.168.1.100", "test_container",
                "/sdcard/Download/file.apk", "/local/path/file.apk"
            )
            
            assert result['code'] == 200
            mock_request.assert_called_once_with(
                'GET', '/down_file/192.168.1.100/test_container',
                params={
    ...
    def test_get_android_boot_status(self):
       ...
       with patch.object(self.client, '_make_request') as mock_request:
           ...
           assert result['code'] == 200
           mock_request.assert_called_once_with(
               'GET', '/get_android_boot_status/192.168.1.100/test_container',
    ...
    def test_install_apk(self):
       ...
       with patch.object(self.client, '_make_request') as mock_request:
           ...
           assert result['code'] == 200
           mock_request.assert_called_once_with(
               'GET', '/install_apk/192.168.1.100/test_container',
    ...
    def test_install_apk_from_url(self):
       ...
       with patch.object(self.client, '_make_request') as mock_request:
           ...
           result = self.client.install_apk_from_url(
               "192.168.1.100", "test_container",
               "https://example.com/app.apk", 3
           )
           
           assert result['code'] == 200
           mock_request.assert_called_once_with(
               'POST', '/install_apk_fromurl/192.168.1.100/test_container',
               data={
    ...
    def test_take_screenshot(self):
        ...
        with patch.object(self.client, '_make_request') as mock_request:
            ...
            result = self.client.take_screenshot(
                "192.168.1.100", "test_container", 3
            )
    ...
    def test_set_app_all_permissions(self):
        ...
        with patch.object(self.client, '_make_request') as mock_request:
            ...
            assert result['code'] == 200
            mock_request.assert_called_once_with(
                'GET', '/set_app_permissions/192.168.1.100/test_container/com.example.app'
            )
    ...
    def test_set_app_resolution_filter(self):
        ...
        with patch.object(self.client, '_make_request') as mock_request:
            ...
            assert result['code'] == 200
            mock_request.assert_called_once_with(
                'GET', '/set_app_resloution_filter/192.168.1.100/test_container/com.example.app/1'
            )
    ...
    def test_set_audio_playback(self):
        ...
        with patch.object(self.client, '_make_request') as mock_request:
            ...
            assert result['code'] == 200
            mock_request.assert_called_once_with(
                'GET', '/set_audio/192.168.1.100/test_container/play',
    ...
    def test_execute_adb_command(self):
        ...
        with patch.object(self.client, '_make_request') as mock_request:
            ...
            assert result['code'] == 200
            mock_request.assert_called_once_with(
                'POST', '/shell/192.168.1.100/test_container',
    ...
    def test_execute_adb_command2(self):
        ...
        with patch.object(self.client, '_make_request') as mock_request:
            ...
            assert result['code'] == 200
            mock_request.assert_called_once_with(
                'POST', '/shell2/192.168.1.100/test_container',
    ...
    def test_upload_google_cert(self):
        ...
        with patch.object(self.client, '_make_request') as mock_request:
            ...
            assert result['code'] == 200
            mock_request.assert_called_once_with(
                'GET', '/upload_google_cert/192.168.1.100/test_container',
    ...
    def test_set_s5_filter_url(self):
        ...
        with patch.object(self.client, '_make_request') as mock_request:
            ...
            assert result['code'] == 200
            mock_request.assert_called_once_with(
                'POST', '/s5_filter_url/192.168.1.100/test_container',
    ...
    def test_query_s5_connection(self):
        ...
        with patch.object(self.client, '_make_request') as mock_request:
            ...
            result = self.client.query_s5_connection(
                "192.168.1.100", "test_container"
            )
