...
class MYTAPIClient:
    ...
    def get_image_list_v2(self, image_type: str) -> Dict[str, Any]:
        ...
        if image_type not in ['p1', 'q1', 'a1', 'c1']:
            raise MYTSDKError(f"无效的镜像类型: {image_type}，支持的类型: p1, q1, a1, c1")
        
        return self._make_request('GET', '/host_api/v1/get_img_list', params={'type': image_type})
    ...
    def create_android_container(self, ip: str, index: int, name: str, 
                               sandbox: int = 0, sandbox_size: int = 16, 
                               image_addr: Optional[str] = None, memory: int = 0,
                               cpu: Optional[str] = None, resolution: int = 0,
                               dns: str = "223.5.5.5", width: int = 720, height: int = 1280,
                               dpi: int = 320, fps: int = 24, data_res: Optional[str] = None,
                               mac: Optional[str] = None, random_dev: int = 1,
                               s5ip: Optional[str] = None, s5port: int = 0,
                               s5user: Optional[str] = None, s5pwd: Optional[str] = None,
                               dnstcp_mode: int = 0, rpaport: int = 0,
                               initdev: Optional[str] = None, enforce: int = 1,
                               yktid: Optional[str] = None, ykuser: Optional[str] = None,
                               yktoken: Optional[str] = None, ykbitrate: Optional[str] = None,
                               phyinput: int = 0, adbport: int = 0, timeoffset: int = 0,
                               enablemeid: int = 0, tcp_map_port: Optional[str] = None,
                               udp_map_port: Optional[str] = None, img_url: Optional[str] = None,
                               bridge_config: Optional[Dict[str, str]] = None) -> Dict[str, Any]:
        """
        创建安卓容器
    ...
    def create_a1_android_container(self, ip, index, name, sandbox=0, sandbox_size=16, 
                                   image_addr=None, memory=0, cpu=None, resolution=0, 
                                   dns="223.5.5.5", width=720, height=1280, dpi=320, 
                                   fps=24, data_res=None, mac=None, random_dev=1, 
                                   s5ip=None, s5port=0, s5user=None, s5pwd=None, 
                                   dnstcp_mode=0, rpaport=0, initdev=None, enforce=1, 
                                   yktid=None, ykuser=None, yktoken=None, ykbitrate=None, 
                                   phyinput=0, adbport=0, timeoffset=0, enablemeid=0, 
                                   tcp_map_port=None, udp_map_port=None, img_url=None):
        """
        创建A1安卓容器
    ...
    def create_p1_android_container(self, ip, index, name, sandbox=0, sandbox_size=16, 
                                   image_addr=None, memory=0, cpu=None, resolution=0, 
                                   dns="223.5.5.5", width=720, height=1280, dpi=320, 
                                   fps=24, data_res=None, mac=None, random_dev=1, 
                                   s5ip=None, s5port=0, s5user=None, s5pwd=None, 
    ...
    def upload_file_to_android(self, ip: str, name: str, local_file: str) -> Dict[str, Any]:
        """
        上传文件到安卓容器
    ...
    def random_device_info(self, ip: str, name: str, userip: Optional[str] = None, 
                          modelid: Optional[str] = None) -> Dict[str, Any]:
        """
        安卓设备随机更换设备信息（同步）
    ...
    def random_device_info_async(self, ip: str, name: str, userip: Optional[str] = None, 
                                modelid: Optional[str] = None) -> Dict[str, Any]:
        """
        安卓设备随机更换设备信息（异步）
    ...
    def random_device_info_async2(self, ip: str, name: str, act: str, 
    ...
    def set_custom_device_info(self, ip: str, name: str, device_data: str,
                              ...
                              vaid: Optional[str] = None) -> Dict[str, Any]:
        """
        自定义设备机型信息（数字孪生）
...
# 便捷函数
    def set_s5_connection(self, ip: str, name: str, s5ip: Optional[str] = None, 
                         s5port: Optional[str] = None, s5user: Optional[str] = None, 
                         s5pwd: Optional[str] = None, domain_mode: Optional[int] = None) -> Dict[str, Any]:
        """
        设置S5连接
    ...
    def set_camera_rotation(self, ip: str, name: str, rot: int, face: int) -> Dict[str, Any]:
        """
        设置摄像头旋转
    ...
    def set_camera_stream(self, ip: str, name: str, v_type: int, 
                         resolution: Optional[int] = None, addr: Optional[str] = None) -> Dict[str, Any]:
        """
        设置摄像头推流地址和类型
    ...
    def set_device_location(self, ip: str, name: str, lat: float, lng: float) -> Dict[str, Any]:
        """
        设置设备经纬度信息
...
def create_client(base_url: str = "http://127.0.0.1:5000", timeout: int = 30) -> MYTAPIClient:
    """
    创建MYT API客户端实例
